...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/metahive.offical?serverTimezone=GMT%2B8&characterEncoding=utf-8");
        ...
        pc.setParent("com.metahive.offical");
        pc.setEntity("entity");
        ...
        strategy.setInclude("product"); // 映射的表名
